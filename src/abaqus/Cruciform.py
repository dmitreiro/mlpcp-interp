...
mdb.models['Model-1'].fieldOutputRequests['F-Output-1'].setValues(variables=(
    ...
    'U','SDV','UVARM'), numIntervals=20)                                                                                                                                                            #Field Output Defining SDV UVARM LE TF 20 FRAMES
...
os.system('Abaqus job=Job-1.inp user=UMMDp_FLC.f interactive ask_delete=OFF')
doe = new( [0.600, 0.600, 0.600, 280.00, 120.00, 0.100], [6.000, 6.000, 6.000, 700.00, 300.00, 0.300], 6, 5000)
